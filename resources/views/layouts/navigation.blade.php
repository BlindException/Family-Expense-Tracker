        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-dropdown>
                        <x-slot name="trigger">
                            <button id = "transactionsBTN" aria-expanded="false">
                    ...
                    <x-dropdown>
                        <x-slot name="trigger">
                            <button id = "transactionCategoriesBTN" aria-expanded="false">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                </svg>
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('transactioncategories.index')">
                                {{ __('Available Transaction Categories') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('transactioncategories.create')">
                                {{ __('Create A New Transaction Category') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                    <x-dropdown>
                        <x-slot name="trigger">
                            <button id = "familiesBTN" aria-expanded="false">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                </svg>
                                {{ ("Families") }}
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('families.create')">
                                {{ __('Create A New Family') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('familyusers.create')">
                                {{ __('Join a Family') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
